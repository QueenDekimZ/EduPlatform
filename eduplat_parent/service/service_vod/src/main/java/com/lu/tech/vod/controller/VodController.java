package com.lu.tech.vod.controller;
...
import com.lu.tech.vod.service.VodService;
import com.lu.tech.vod.utils.ConstantVodUtils;
import com.lu.tech.vod.utils.InitVodCilent;
...
public class VodController {
    ...
    public R removeAlyVideo(@PathVariable String id) {
        try {
            ...
            e.printStackTrace();
            throw new LuException(20001,"删除视频失败");
        }
    }
    ...
    public R getPlayAuth(@PathVariable String id) {
        try {
            ...
            throw new LuException(20001,"获取凭证失败");
        }
    }
